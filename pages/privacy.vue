<template>
    <div class="privacy">
        ...
        <p>
            †タスク ドラゴン ナイト†（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
        </p>
        ...
        <p>
            ...
            社名：†タスク ドラゴン ナイト†<br>
            Eメールアドレス：support@folivora.sukiyaki.party<br>
            以上
        </p>
    </div>
</template>
